...
function TermsAndConditions(){
    return(
        <div className={"main-div"}>
            <h1 className={"checkout-h1"}>TERMS AND CONDITIONS</h1>
            <Menu />
            <p>
                ...
                6.7 Once you purchase a Program and we, or the Seller, make it available to you, you are responsible for downloading (if applicable) and confirming your ability to access the Program, including retrieving the license key for the Program, if applicable, and you shall bear all risk of loss thereafter, including any loss due to a computer or hard drive malfunction. If you are unable to complete a download or access a Program, please contact CDKeys.com’s customer service for assistance at support@cdkeys.com.
                ...
                13.1 If you wish to terminate this Agreement, you may simply discontinue using CDKeys.com. If you wish to delete your Account data, please contact CDKeys.com at support@cdkeys.com. We will retain and use your information as necessary to comply with our legal obligations, to resolve disputes, and to enforce our agreements, and we will delete your full profile to the extent possible (if applicable).
                ...
                16.5 Notices to CDKeys.com: Reports, statements, notices and any other communications may be transmitted by a User to CDKeys.com at info@cdk.ae. All communications and notices shall be deemed to be received, or served (as applicable), to CDKeys.com when electronically received by CDKeys.com at info@cdk.ae.
